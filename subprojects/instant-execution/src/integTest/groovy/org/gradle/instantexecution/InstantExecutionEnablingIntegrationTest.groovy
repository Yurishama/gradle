...
class InstantExecutionEnablingIntegrationTest extends AbstractInstantExecutionIntegrationTest {
    ...
    @Unroll
    def "can enable with a #origin on the command line"() {
    ...
    def "can enable with a gradle property in root directory gradle.properties"() {
    ...
    def "can enable with a gradle property in gradle user home gradle.properties"() {
    ...
    @Unroll
    def "can disable with a #origin on the command line when enabled in gradle.properties"() {
